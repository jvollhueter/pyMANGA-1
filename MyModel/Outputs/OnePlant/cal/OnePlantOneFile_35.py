...
result_files_1 = glob.glob(r'35\1\*.csv')
result_files_2 = glob.glob(r'35\2\*.csv')
result_files_3 = glob.glob(r'35\3\*.csv')
result_files_4 = glob.glob(r'35\4\*.csv')

pj = 'ini'

if not os.path.exists('fig/35'):
...
for result_file in result_files_1:
    ...
    fig.savefig('fig/35/geometries.png')
    # plt.close('all')
...
plt.savefig('fig/35/all_types.png')
...
for n in [all_trees_1,
    ...
    plt.savefig('fig/35/grow_maint_res_bvol_'+str(i)+'.png')
    # plt.close('all')
